...
function ClientHome({ client, goTo }) {
  ...
  return <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr)", gap: 10, maxWidth: "100%", overflowX: "hidden", position: "relative" }}>
    ...
    {goTo && showPaymentBanner && (
      <div onClick={() => goTo("payments")} style={{ cursor: "pointer", background: BRAND.card, border: `1.5px solid ${daysToPayment < 0 ? "rgba(220,80,70,0.5)" : HOME_TRACK}`, borderRadius: 16, padding: 14 }}>
    ...
    {goTo && checkinDue && (
      <div onClick={() => goTo("checkins")} style={{ cursor: "pointer", background: BRAND.card, border: `1.5px solid ${HOME_TRACK}`, borderRadius: 16, padding: 14 }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 10 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
    ...
    <div style={{ background: BRAND.card, border: `${BRAND.hairline} solid ${BRAND.line}`, borderRadius: 16, padding: 14 }}>
      <div style={{ fontFamily: BRAND.sans, fontSize: 9, fontWeight: 600, color: BRAND.muted, letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 7 }}>Today's Workout</div>
      {workout ? (
        <>
    ...
    {goTo && latestCoachMsg && (
      <div onClick={() => goTo("messages")} style={{ cursor: "pointer", background: BRAND.card, border: `${BRAND.hairline} solid ${BRAND.line}`, borderRadius: 16, padding: 14, display: "flex", alignItems: "center", gap: 12 }}>
