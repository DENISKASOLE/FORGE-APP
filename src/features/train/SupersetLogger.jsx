...
export function SupersetLogger({ group, exById, logsBefore, taxonomyMap = {}, customExercises = [], rpePickerFor, setRpePickerFor, patchSet, addSet, toggleDone, onPlayVideo, onExit }) {
